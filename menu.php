<h2 class="grid_12 caption">   
    Administración <span>general</span>
</h2>
<div class="grid_12">
    <ul>
        <!--<li><a href="index.php?cuerpo=rejilla_direccion.php">direccion</a></li>-->
        <li><a href="index.php?cuerpo=rejilla_especialidad.php">especialidad</a></li>
        <!--<li><a href="index.php?cuerpo=rejilla_examen.php">examen</a></li>-->
        <li><a href="index.php?cuerpo=rejilla_familia.php">familia</a></li>
